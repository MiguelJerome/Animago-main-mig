...
export default function ProduitItemBtnAjouterPanier({
  ...
  const handleClick = (event) => {
    ...
    if (!quantite) {
      toast.info("Le nombre d'articles que vous essayez d'ajouter à votre panier est actuellement de 0. Veuillez augmenter la quantité pour ajouter des articles à votre panier.",{ hideProgressBar: true, autoClose: 2000, type: 'info' ,position:'top-left' });
      return;
    }
